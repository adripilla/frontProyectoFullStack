    ...
    methods: {
      async submitForm() {
        try {
          ...
          const response = await axios.post('http://localhost:3000/api/celular', formData, {
            headers: {
          ...
          Swal.fire({
            title: '¡Éxito!',
            text: 'Celular guardado exitosamente',
            icon: 'success',
          ...
          console.log('Celular guardado:', response.data);
          ...
          console.error('Error al guardar el celular:', error);
          Swal.fire({
            title: '¡Error!',
